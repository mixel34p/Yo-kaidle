...
// Importar FeedbackPanel y SuggestionPanel de forma dinámica
  ...
  return (
    <footer className="fixed bottom-0 left-0 right-0 w-full bg-gradient-to-r from-blue-700/90 to-blue-900/90 text-white py-2 sm:py-3 px-4 shadow-lg backdrop-blur-sm border-t border-blue-400/30 z-40">
      <div className="max-w-screen-xl mx-auto flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-4">
        ...
        {/* Centro: Botón de Feedback y Sugerencias */}
        <div id="feedback-root" className="flex-shrink-0 flex items-center gap-2">
          <FeedbackPanel />
          <SuggestionPanel />
        </div>
        ...
        <div className="flex items-center gap-2 sm:gap-4">
          ...
          {/* BuyMeACoffee */}
          <a
            href="https://patreon.com/yokaidle"
            target="_blank"
            rel="noopener noreferrer"
          ...
          {/* GitHub */}
          <a
            href="https://github.com/mixel34p/Yo-kaidle"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center p-2 bg-gray-800 hover:bg-black rounded-lg transition-colors duration-200"
            aria-label="GitHub"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
