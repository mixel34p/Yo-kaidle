...
import { Yokai, Tribe, Game, tribeTranslations, tribeIcons, gameLogos } from '@/types/yokai';
import { 
  loadMedallium, 
            ...
            <div className="p-5">
              ...
              <div className="grid grid-cols-3 gap-3 mb-5">
                ...
                <div className="bg-blue-50 p-3 rounded-lg flex flex-col items-center justify-center shadow-sm">
                  <div className="text-xs text-blue-600 mb-1">Rango</div>
                  <div className="text-lg font-bold text-blue-800">{selectedYokai.rank}</div>
                </div>
                
                {/* Elemento */}
                <div className="bg-blue-50 p-3 rounded-lg flex flex-col items-center justify-center shadow-sm">
                  <div className="text-xs text-blue-600 mb-1">Elemento</div>
                  <div className="flex items-center">
                    ...
                    <span className="font-medium">{selectedYokai.element}</span>
                  </div>
                </div>
                
                {/* Comida favorita */}
                <div className="bg-blue-50 p-3 rounded-lg flex flex-col items-center justify-center shadow-sm">
                  <div className="text-xs text-blue-600 mb-1">Comida</div>
                  <div className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1 text-blue-700" viewBox="0 0 20 20" fill="currentColor">
                      <path d="M3 1a1 1 0 000 2h1.22l.305 1.222a.997.997 0 00.01.042l1.358 5.43-.893.892C3.74 11.846 4.632 14 6.414 14H15a1 1 0 000-2H6.414l1-1H14a1 1 0 00.894-.553l3-6A1 1 0 0017 3H6.28l-.31-1.243A1 1 0 005 1H3zM16 16.5a1.5 1.5 0 11-3 0 1.5 1.5 0 013 0zM6.5 18a1.5 1.5 0 100-3 1.5 1.5 0 000 3z" />
                    </svg>
                    <span className="font-medium text-sm truncate">{selectedYokai.favoriteFood}</span>
                  </div>
                </div>
              </div>
